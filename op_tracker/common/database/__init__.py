...
from sqlalchemy import create_engine, MetaData, inspect, Table, Column, Integer, String
...
engine: Engine = create_engine(f"sqlite:///{WORK_DIR}/{CONFIG.get('db')}.db",
